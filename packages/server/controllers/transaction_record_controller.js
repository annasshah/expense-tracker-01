...
const transaction_aggregation = async (userId, format) => {
...
const new_transaction = async (req, res) => {
    ...
    const transaction_data = await transaction_aggregation(userId, "%d/%m/%Y")
...
const get_all_transactions = async (req, res) => {
    ...
    const transactions = await transaction_aggregation(userId, "%d/%m/%Y")
